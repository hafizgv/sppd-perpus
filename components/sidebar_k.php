<div class="p-3 space-y-2 md:w-60 w-auto bg-gray-50 shadow-lg dark:bg-gray-900 dark:text-gray-100">
	<div class="flex flex-col items-center p-2">
		...
		<h2 class="text-lg font-semibold md:block hidden">Kabid</h2>
	</div>
	<div class="divide-y divide-gray-400 dark:divide-gray-700">
		<ul class="pt-2 pb-4 space-y-1 text-sm">
			...
			<li>
				<a rel="noopener noreferrer" href="spd.php"class="hover:bg-yellow-300 flex md:flex-row flex-col items-center p-2 space-x-3 rounded-md cursor-pointer">
