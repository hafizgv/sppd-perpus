	...
	<div class="divide-y divide-gray-400 dark:divide-gray-700">
		<ul class="pt-2 pb-4 space-y-1 text-sm">
			<li class="dark:bg-gray-800 dark:text-gray-50">
				<a rel="noopener noreferrer" href="index.php" class="hover:bg-yellow-300 flex items-center p-2 space-x-3 rounded-md">
			...
			<li>
				<a rel="noopener noreferrer" href="lpd.php" class="hover:bg-yellow-300 flex items-center p-2 space-x-3 rounded-md">
			...
			<li>
				<div class="hover:bg-yellow-300 flex items-center p-2 space-x-3 rounded-md cursor-pointer" onclick="show('A')">
		...
		<ul class="pt-4 pb-2 space-y-1 text-sm">
			<li>
				<a rel="noopener noreferrer" href="../logout.php" class="hover:bg-red-600 hover:text-white flex items-center p-2 space-x-3 rounded-md">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-5 h-5 fill-current dark:text-gray-400">
