	...
	<body>
		<section class="bg-gray-50 dark:bg-gray-900">
			<div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
				<div class="flex flex-col gap-5 items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
					<img width="100" src="public/bookicon.png" alt="logo">
					<p>Sistem Informasi SPPD Dinas Perpustakaan dan Kearsipan Kota Langsa </p>
				</div>
